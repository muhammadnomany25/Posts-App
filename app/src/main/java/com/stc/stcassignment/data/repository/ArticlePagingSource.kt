...
import com.stc.stcassignment.domain.util.Constants.Companion.ALL_SEARCH_QUERY
...
@Inject constructor(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Article> {
        return try {
            ...
            val response = api.getArticles(API_KEY, ALL_SEARCH_QUERY, page, PAGINATION_PAGE_SIZE)
